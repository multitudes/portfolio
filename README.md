...
This is the final project for [the certificate](https://multitudes.github.io/images/hacking with swift certificate.jpg) of the [100 Days of Swift](https://www.hackingwithswift.com/100) by [Paul Hudson](https://twitter.com/twostraws). The challenge was to create a memory pairs game that has players find pairs of cards – it’s sometimes called Concentration, Pelmanism, or Pairs.  
